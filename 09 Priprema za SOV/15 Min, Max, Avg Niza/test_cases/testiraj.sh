...
OUTP01=$(cat <<EOL
Unesite do 20 heksadecimalnih brojeva: 7 8 9 6 7
Unesite opciju (cifra 1-4): 1
 6
EOL
)
...
OUTP02=$(cat <<EOL
Unesite do 20 heksadecimalnih brojeva: 7 8 AA 6 7
Unesite opciju (cifra 1-4): 2
 170
EOL
)
...
OUTP03=$(cat <<EOL
Unesite do 20 heksadecimalnih brojeva: 7 8 9 6 7 a b c
Unesite opciju (cifra 1-4): 3
 8
EOL
)
...
OUTP04=$(cat <<EOL
Unesite do 20 heksadecimalnih brojeva: 7 8 9 6 7 w
1
EOL
)
...
OUTP05=$(cat <<EOL
Unesite do 20 heksadecimalnih brojeva: 7 8 9 6 7 b
Unesite opciju (cifra 1-4): 4
 2
EOL
)
...
OUTP06=$(cat <<EOL
Unesite do 20 heksadecimalnih brojeva: 7 8 9 6 7 b 1 2 dd
Unesite opciju (cifra 1-4): 4
 4558
EOL
)
...
OUTP07=$(cat <<EOL
Unesite do 20 heksadecimalnih brojeva: 7 8 9 6 7 b 5 6 cc
Unesite opciju (cifra 1-4): 2 
 204
EOL
)
...
TEST08=$(cat <<EOL
7 8 9 6 7 b 1 2 3 4 5 6 7 8 9 ab c d e f 1 2 3 44 55 66 77 8 a d a d
4
EOL
)

OUTP08=$(cat <<EOL
Unesite do 20 heksadecimalnih brojeva: 7 8 9 6 7 b 1 2 3 4 5 6 7 8 9 ab c d e f 1 2 3 44 55 66 77 8 a d a d
4
EOL
)
...
OUTP09=$(cat <<EOL
Unesite do 20 heksadecimalnih brojeva: 7 8 9 6 7 b 1 2 3
Unesite opciju (cifra 1-4): 5
EOL
)
