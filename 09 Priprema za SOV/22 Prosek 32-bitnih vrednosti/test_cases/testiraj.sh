...
OUTP01=$(cat <<EOL
Unesite 10 elemenata niza: 100 200 300 400 500 1000
Prosecna vrednost niza iznosi: 416
EOL
)

TEST02=$(cat <<EOL
1 2 3 4 pet 6 7 8 9 10
EOL
)

OUTP02=$(cat <<EOL
Unesite 10 elemenata niza: 1 2 3 4 pet 6 7 8 9 10
Greska u konverziji!
EOL
)
...
OUTP03=$(cat <<EOL
Unesite 10 elemenata niza: 4294967296 1
