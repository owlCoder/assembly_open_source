...
EXITS=(0 0 0 0 1 1 4 3 3 3 1 1 2)
EMPTY="#"
QUIET=0
KEEP=0
SIG=""
...
OUTP01=$(cat <<EOL
Unesite broj naredbi: 4
Unesite naredbe (naredba po liniji):
ADD \$0x123,%R1
MUL \$0x2,%R1
SUB \$0x245,%R1
ADD \$0x1,%R1
Vrednost u registru R1 nakon operacija: 2
EOL
)
...
OUTP02=$(cat <<EOL
Unesite broj naredbi: 1
Unesite naredbe (naredba po liniji):
ADD \$0x123,%R1
Vrednost u registru R1 nakon operacija: 291
EOL
)
