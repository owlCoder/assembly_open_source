...
OUTP01=$(cat <<EOL
Unesite do 10 brojeva: 7 8 9 10
Transformisan  niz:  7 15 24 60
EOL
)
...
OUTP02=$(cat <<EOL
Unesite do 10 brojeva: 1abcaa 5g6g7g
Transformisan  niz:  60024 314263
EOL
)

TEST03=$(cat <<EOL
zxcvww bnm577 wfgfhb w46784 w4dfdga fghjka
EOL
)

OUTP03=$(cat <<EOL
Unesite do 10 brojeva: zxcvww bnm577 wfgfhb w46784 w4dfdga fghjka
Greska2
EOL
)
...
OUTP05=$(cat <<EOL
Unesite do 10 brojeva: 1 1 1 1
Transformisan  niz:  1 2 3 4
EOL
)

TEST06=$(cat <<EOL
zxcvww bnm577ff wfgfhb 
EOL
)

OUTP06=$(cat <<EOL
Unesite do 10 brojeva: zxcvww bnm577ff wfgfhb 
Greska1 
EOL
)
