...
TEST01=$(cat <<EOL
I 0x150 O 0x130 T 0x15
EOL
)

OUTP01=$(cat <<EOL
Unesite transakciju: I 0x150 O 0x130 T 0x15
Preneseno je 21RSD i na izvornom racunu je ostalo 315RSD a na odredisnom racunu je sada saldo 325RSD.
EOL
)

TEST02=$(cat <<EOL
i 0x150 T 0x150  O 0x130
EOL
)

OUTP02=$(cat <<EOL
Unesite transakciju: i 0x150 T 0x150  O 0x130
Preneseno je 336RSD i na izvornom racunu je ostalo 0RSD a na odredisnom racunu je sada saldo 640RSD.
EOL
)
...
OUTP03=$(cat <<EOL
Unesite transakciju:   O 0x130    i 0x150
Doslo je do greske!
EOL
)

TEST04=$(cat <<EOL
T 0x150  O 0x130 O 0x5130        i 0x150 
EOL
)

OUTP04=$(cat <<EOL
Unesite transakciju: T 0x150  O 0x130 O 0x5130        i 0x150 
Doslo je do greske!
EOL
)

TEST05=$(cat <<EOL
T 0x160  O 0x130    i 0x150 
EOL
)

OUTP05=$(cat <<EOL
Unesite transakciju: T 0x160  O 0x130    i 0x150 
Doslo je do greske!
EOL
)

TEST06=$(cat <<EOL
T 0x10  O 0xffffffff    i 0x150 
EOL
)

OUTP06=$(cat <<EOL
Unesite transakciju: T 0x10  O 0xffffffff    i 0x150 
Doslo je do greske!
EOL
)

TEST07=$(cat <<EOL
i 0x150  O 0x130 t 0x150
EOL
)

OUTP07=$(cat <<EOL
Unesite transakciju: i 0x150  O 0x130 t 0x150
Preneseno je 336RSD i na izvornom racunu je ostalo 0RSD a na odredisnom racunu je sada saldo 640RSD.
EOL
)

TEST08=$(cat <<EOL
i 0x150  O 0x130 t 0x
EOL
)

OUTP08=$(cat <<EOL
Unesite transakciju: i 0x150  O 0x130 t 0x
Doslo je do greske!
EOL
)

TEST09=$(cat <<EOL
i 0x150  O 0x130 t 0546
EOL
)

OUTP09=$(cat <<EOL
Unesite transakciju: i 0x150  O 0x130 t 0546
Doslo je do greske!
EOL
)

TEST10=$(cat <<EOL
i 0x150  O 0x130 t x33
EOL
)

OUTP10=$(cat <<EOL
Unesite transakciju: i 0x150  O 0x130 t x33
Doslo je do greske!
EOL
)

TEST11=$(cat <<EOL
i 0x150  O 0x130 t 0X33
EOL
)

OUTP11=$(cat <<EOL
Unesite transakciju: i 0x150  O 0x130 t 0X33
Doslo je do greske!
EOL
)

TEST12=$(cat <<EOL
i 0x150  p 0x130 t 0X33
EOL
)

OUTP12=$(cat <<EOL
Unesite transakciju: i 0x150  p 0x130 t 0X33
Doslo je do greske!
EOL
)
