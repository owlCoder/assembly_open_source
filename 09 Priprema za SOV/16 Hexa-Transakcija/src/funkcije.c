...
int cprintf(const char *format, ...) {
    ...
    va_end(ap);
    string_replace(&buff,"{BLU}", TESTIRAJ?"":"\033[1;34m");
    string_replace(&buff,"{GRN}", TESTIRAJ?"":"\033[1;32m");
    string_replace(&buff,"{CYN}", TESTIRAJ?"":"\033[1;36m");
    string_replace(&buff,"{RED}", TESTIRAJ?"":"\033[1;31m");
    string_replace(&buff,"{MAG}", TESTIRAJ?"":"\033[1;35m");
    string_replace(&buff,"[BLU]", TESTIRAJ?"":"\033[1;44m");
    string_replace(&buff,"[GRN]", TESTIRAJ?"":"\033[1;42m");
    string_replace(&buff,"[CYN]", TESTIRAJ?"":"\033[1;46m");
    string_replace(&buff,"[RED]", TESTIRAJ?"":"\033[1;41m");
    string_replace(&buff,"[MAG]", TESTIRAJ?"":"\033[1;45m");
    string_replace(&buff,"{NRM}", TESTIRAJ?"":"\033[0m");
    string_replace(&buff,"[NRM]", TESTIRAJ?"":"\033[0m");
    ret=printf("%s",buff);
    free(buff);
    return ret;
