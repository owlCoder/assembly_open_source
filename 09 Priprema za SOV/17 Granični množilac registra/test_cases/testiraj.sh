...
OUTP01=$(cat <<EOL
Unesite vrednosti r1 r2 gr: 123 456 1948
Unesite adresiranje: (r1,r2,4)
Adresa: 1947
EOL
)

TEST02=$(cat <<EOL
4294967294 0 4294967295
(r1,r2,4)
EOL
)

OUTP02=$(cat <<EOL
Unesite vrednosti r1 r2 gr: 4294967294 0 4294967295
Unesite adresiranje: (r1,r2,4)
Adresa: 4294967294
EOL
)
...
OUTP03=$(cat <<EOL
Unesite vrednosti r1 r2 gr: 4294967294 1 4294967295
Unesite adresiranje: (r2,r1,1)
Adresa nije validna.
EOL
)

TEST04=$(cat <<EOL
11111111 22222222 66666667
(r2,r2,2)
EOL
)

OUTP04=$(cat <<EOL
Unesite vrednosti r1 r2 gr: 11111111 22222222 66666667
Unesite adresiranje: (r2,r2,2)
Adresa: 66666666
EOL
)
...
OUTP05=$(cat <<EOL
Unesite vrednosti r1 r2 gr: 4294967296 1 1
Greska kod adrese.
(r2,r2,2)
EOL
)
...
OUTP06=$(cat <<EOL
Unesite vrednosti r1 r2 gr: 429497294 12a3 456
Greska kod adrese.
(r2,r2,2)
EOL
)
...
OUTP07=$(cat <<EOL
Unesite vrednosti r1 r2 gr: 123 456 789
Unesite adresiranje: (r1,R1,2)
Greska kod adresiranja
EOL
)
