...
OUTP01=$(cat <<EOL
Unesite izraz u formatu poljske notacije: 1 2 3 + + 5 +
Rezultat izraza je: 11
EOL
)
...
OUTP02=$(cat <<EOL
Unesite izraz u formatu poljske notacije: 6 6 + 5 5 + +
Rezultat izraza je: 22
EOL
)
...
OUTP03=$(cat <<EOL
Unesite izraz u formatu poljske notacije: 2 2 3 6 +
Izraz nije unet u validnom formatu!
EOL
)
