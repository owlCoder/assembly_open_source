...
OUTP03=$(cat <<EOL
Ulazna sekvenca:   22   8    7     5    3    2    1
Izlazna sekvenca: 22
EOL
)
...
Izlazna sekvenca: 0 0 1 2 300000000
EOL
)
...
Izlazna sekvenca: 12345 45678 89123
EOL
)

TEST09=$(cat <<EOL
42 119 911 777 1312 4323
EOL
)

OUTP09=$(cat <<EOL
Ulazna sekvenca: 42 119 911 777 1312 4323
Izlazna sekvenca: 42 119 911 1312 4323
EOL
)
...
OUTP10=$(cat <<EOL
Ulazna sekvenca: 1 2 4 8 16 32 64 128 256 512 1024
Izlazna sekvenca: 1 2 4 8 16 32 64 128 256 512 1024
EOL
)
